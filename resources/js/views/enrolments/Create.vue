<!--
@Date:   2020-03-31T14:16:53+01:00
@Last modified time: 2020-04-06T22:20:54+01:00
-->
        ...
        <b-row>
                ...
                <b-form @submit="onSubmit">
                    <b-form-row>
                        ...
                        <b-col cols="12">
                            <b-form-group id="course_id" label="Course" label-for="course_id">
                                <b-form-select id="course_id" v-model="form.course_id" required>
                                    <b-form-select-option v-for="course in courses" v-bind:value="course.id" :key="course.id">
                                        {{ course.title }}
                        ...
                        <b-col cols="12">
                            <b-form-group id="lecturer_id" label="Lecturer" label-for="lecturer_id">
                                <b-form-select id="lecturer_id" v-model="form.lecturer_id" required >
                                    <b-form-select-option v-for="lecturer in lecturers" v-bind:value="lecturer.id" :key="lecturer.id">
                                        {{ lecturer.name }}
                                    </b-form-select-option>
                                </b-form-select>
                            </b-form-group>
